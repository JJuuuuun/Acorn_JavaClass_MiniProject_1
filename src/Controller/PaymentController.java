...
//	@FXML public static Label lblcoupon;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		int c = 15900;
		int d = 21900;
		Btn1m.setOnAction(event -> OGmoney.setText(a +"원"));
		Btn3m.setOnAction(event -> OGmoney.setText(b +"원"));
		Btn6m.setOnAction(event -> OGmoney.setText(c +"원"));
		Btn12m.setOnAction(event -> OGmoney.setText(d +"원"));
